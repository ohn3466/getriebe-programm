...
def generate_calculation_report(inputs: GearInputs, results: GearResults, bearings: list[dict[str, Any]]) -> str:
    ...
    lines: list[str] = [
        ...
        f"- Durchmesser unter dem Gegenrad: `d_sh,2 = {de(inputs.d_sh_wheel_mm)} mm`",
        ...
        "",
        f"- Gewaehlter Gegenrad-Wellensitz: **`d_sh,2 = {de(inputs.d_sh_wheel_mm)} mm`**",
        "",
        "## 4. Modulbestimmung",
        "",
    ]
...
def generate_latex_report(inputs: GearInputs, results: GearResults, bearings: list[dict[str, Any]]) -> str:
    ...
    lines: list[str] = [
        ...
        rf"Durchmesser unter dem Gegenrad & $d_{{sh,2}} = {tex_num(inputs.d_sh_wheel_mm)}\,\mathrm{{mm}}$ \\",
        ...
        r"\end{align*}",
        rf"Gewaehlter Gegenrad-Wellensitz: $d_{{sh,2}} = {tex_num(inputs.d_sh_wheel_mm)}\,\mathrm{{mm}}$",
        "",
